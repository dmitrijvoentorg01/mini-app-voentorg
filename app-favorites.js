...
function showPopular() {
  ...
  var pop = sortByViews(products.slice().filter(function(p){ return p.views > 0 && !(parseInt(p.stock, 10) === 0); })).slice(0, 10);
  ...
  var h = '<div class="page-back-btn" onclick="backToMenu()"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/back.png?v=1" class="page-back-icon"></div>' +
    '<h2 class="section-title"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/popular.png?v=1" class="section-icon">САМЫЕ ПРОСМАТРИВАЕМЫЕ</h2>';
    ...
    pop.forEach(function(p) {
      ...
      h += '<div class="popular-card" data-id="' + p.id + '">' +
        '<div class="popular-card-photo">' +
          ...
          '<div class="card-hit-badge"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/fire.png?v=1" style="width:12px;height:12px;vertical-align:middle;margin-right:2px;">ТОП</div>' +
        '</div>' +
...
function showFavorites() {
  ...
  var h = '<div class="page-back-btn" onclick="showCabinetPage()"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/back.png?v=1" class="page-back-icon"></div>' +
    '<h2 class="section-title"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/reviews.png?v=1" class="section-icon">Избранное</h2>';
...
function showNewItems() {
  ...
  var h = '<div class="page-back-btn" onclick="backToMenu()"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/back.png?v=1" class="page-back-icon"></div>' +
    '<h2 class="section-title"><img src="https://nkbrclrbubhxnmzbubvs.supabase.co/storage/v1/object/public/icons/new_items.png?v=1" class="section-icon">Новинки</h2>';
